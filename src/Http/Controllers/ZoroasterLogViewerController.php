<?php
    ...
    namespace KarimQaderi\ZoroasterLogViewer\Http\Controllers;
    ...
    class ZoroasterLogViewerController extends Controller
    {
        /**
        ...
        public function getListLogs(Request $request)
        {
            ...
            return view('zoroaster-log-viewer::tool')->with([
                'headers' => $headers ,
                'rows' => $rows
            ]);
        }
        ...
        public function showByLevel($date , $level)
        {
            ...
            return view('zoroaster-log-viewer::log')->with([
                'log' => $log ,
                'info' => [
                    'path' => $log->getPath() ,
                    'size' => $log->size() ,
        ...
        public function delete(Request $request)
        {
            ...
            $massage_type = $this->logViewer->delete($date) ? 'success' : 'error';

            if($massage_type == 'success')
                $massage = 'با موفقیت حذف شد';
            else
                $massage = 'مشکلی به وجود';

            return redirect(route('Zoroaster-log-viewer.getListLogs'))->with([
